...
export interface QueryRequest {
  ...
  price?: [{ symbol: String }, PriceRequest]
  total?: TotalRequest
...
export interface TotalRequest {
  ...
  cycSupply?: boolean | number
  lpLocked?: boolean | number
  lpOldLocked?: boolean | number
  fee?: boolean | number
  __typename?: boolean | number
  __scalar?: boolean | number
}
...
export interface DepositRequest {
  ...
  timestamp?: boolean | number
  coinDenomination?: boolean | number
  tokenDenomination?: boolean | number
  cycDenomination?: boolean | number
  __typename?: boolean | number
  __scalar?: boolean | number
}
...
const APY_possibleTypes = ['APY']
export const isAPY = (obj: { __typename: String }): obj is APY => {
  if (!obj.__typename) throw new Error('__typename is missing')
  return APY_possibleTypes.includes(obj.__typename)
}
...
export interface QueryPromiseChain {
  ...
  price: (args: {
    symbol: String
  }) => PricePromiseChain & { execute: (request: PriceRequest, defaultValue?: Price) => Promise<Price> }
  ...
  apy: { execute: (request: APYRequest, defaultValue?: (APY | null)[]) => Promise<(APY | null)[]> }
}
...
export interface QueryObservableChain {
  ...
  price: (args: {
    symbol: String
  }) => PriceObservableChain & { execute: (request: PriceRequest, defaultValue?: Price) => Observable<Price> }
  ...
  apy: { execute: (request: APYRequest, defaultValue?: (APY | null)[]) => Observable<(APY | null)[]> }
}
...
export interface TotalPromiseChain {
  pool: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
  deposit: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
  cycSupply: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
  lpLocked: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
  lpOldLocked: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
  fee: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
}

export interface TotalObservableChain {
  pool: { execute: (request?: boolean | number, defaultValue?: Float) => Observable<Float> }
  deposit: { execute: (request?: boolean | number, defaultValue?: Float) => Observable<Float> }
  cycSupply: { execute: (request?: boolean | number, defaultValue?: Float) => Observable<Float> }
  lpLocked: { execute: (request?: boolean | number, defaultValue?: Float) => Observable<Float> }
  lpOldLocked: { execute: (request?: boolean | number, defaultValue?: Float) => Observable<Float> }
...
export interface DepositPromiseChain {
  ...
  timestamp: { execute: (request?: boolean | number, defaultValue?: Int64) => Promise<Int64> }
  coinDenomination: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  tokenDenomination: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  cycDenomination: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
}
...
export interface DepositObservableChain {
  ...
  timestamp: { execute: (request?: boolean | number, defaultValue?: Int64) => Observable<Int64> }
  coinDenomination: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  tokenDenomination: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  cycDenomination: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
}

export interface APYPromiseChain {
  address: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  apy: { execute: (request?: boolean | number, defaultValue?: Float) => Promise<Float> }
}

export interface APYObservableChain {
  address: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  apy: { execute: (request?: boolean | number, defaultValue?: Float) => Observable<Float> }
}
